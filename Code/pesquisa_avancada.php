...
function closeNav() {
  ...
  document.getElementById("main").style.marginLeft= "0";
    ...
    <form action="procura.php" method="get" class="pt2 pb1 align--center">
      <label for="lenght">Comprimento </label><input type="text" name="lenght" id="lenght"> <br><br>
      <label for="width">Largura </label><input type="text" name="width" id="width"> <br><br>
      <label for="thickness">Grossura </label><input type="text" name="thickness" id="thickness"> <br><br>
...
$ch = curl_init("http://localhost:8080/exist/rest/db/apps/MegaLOD");
        ...
        curl_setopt($ch, CURLOPT_USERPWD, "admin:admin");
				...
				curl_setopt($ch, CURLOPT_URL, "http://localhost:8080/exist/rest/db/apps/MegaLOD/teste.xquery");
